...
void glwin::setup_menu() {  // you may add here your new menu entries
  ...
  action = new QAction("Load Scalar Field", this);
...
//
void glwin::loadMesh() {
  file = QFileDialog::getOpenFileName(NULL, "Select a mesh to add:", "", "Meshes (*.obj *.ply *.stl *.off *.om);;All Files (*)");
